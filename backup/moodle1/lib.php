...
/**
 * giportfolio conversion handler
 */
class moodle1_mod_giportfolio_handler extends moodle1_mod_handler {
     ...
     *
     * Note that the path /MOODLE_BACKUP/COURSE/MODULES/MOD/giportfolio does not
    ...
    public function get_paths() {
        return array(
            new convert_path('giportfolio', '/MOODLE_BACKUP/COURSE/MODULES/MOD/giportfolio',
                    array(
                        'renamefields' => array(
                            'summary' => 'intro',
                        ),
            ...
            new convert_path('giportfolio_chapters', '/MOODLE_BACKUP/COURSE/MODULES/MOD/giportfolio/CHAPTERS/CHAPTER',
                    array(
                        'newfields' => array(
    ...
    public function process_giportfolio($data) {
        ...
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $this->moduleid,
            'modulename' => 'giportfolio', 'contextid' => $contextid));
    ...
    /**
     * This is executed every time we have one /MOODLE_BACKUP/COURSE/MODULES/MOD/giportfolio/CHAPTERS/CHAPTER
     * data available
     * @param array $data
     */
    public function process_giportfolio_chapters($data) {
     ...
     */
    public function on_giportfolio_chapters_start() {
     ...
     */
    public function on_giportfolio_chapters_end() {
        $this->xmlwriter->end_tag('chapters');
    }

    /**
     * This is executed when we reach the closing </MOD> tag of our 'giportfolio' path
     */
    public function on_giportfolio_end() {
        // Finalize giportfolio.xml.
        $this->xmlwriter->end_tag('giportfolio');
        $this->xmlwriter->end_tag('activity');
        $this->close_xml_writer();

        // Write inforef.xml.
        $this->open_xml_writer("activities/giportfolio_{$this->moduleid}/inforef.xml");
