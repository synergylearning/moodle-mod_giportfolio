...
/**
 * The mod_giportfolio chapter viewed event.
 *
...
/**
 * The mod_giportfolio chapter viewed event class.
 *
 * @package    mod_giportfolio
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class chapter_viewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the chapter with id '$this->objectid' for the giportfolio with " .
    ...
    public static function get_name() {
        return get_string('eventchapterviewed', 'mod_giportfolio');
    }
