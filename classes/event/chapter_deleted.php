...
/**
 * The mod_giportfolio chapter deleted event.
 *
...
/**
 * The mod_giportfolio chapter deleted event class.
 *
 * @package    mod_giportfolio
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class chapter_deleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the chapter with id '$this->objectid' for the giportfolio with " .
    ...
    public static function get_name() {
        return get_string('eventchapterdeleted', 'giportfolio');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/giportfolio/view.php', array('id' => $this->contextinstanceid));
    }
