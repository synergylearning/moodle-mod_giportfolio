...
/**
 * The mod_giportfolio chapter created event.
 *
...
/**
 * The mod_giportfolio chapter created event class.
 *
 * @package    mod_giportfolio
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class chapter_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the chapter with id '$this->objectid' for the giportfolio with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'giportfolio', 'add chapter', 'view.php?id=' . $this->contextinstanceid . '&chapterid=' .
