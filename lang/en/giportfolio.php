...
$string['displayoutline'] = 'Display Chapter Outline';
$string['displayoutline_help'] = 'If enabled, an outline is displayed allowing for easy navigation to a specific contribution';
$string['outline'] = 'Outline';
$string['outline_show'] = 'Show';
$string['outline_hide'] = 'Hide';
