...
$chnavigation = '';
if ($previd) {
    $chnavigation .= '<a title="'.get_string('navprev', 'mod_giportfolio').'" href="viewcontribute.php?id='.$cm->id.
...
if ($nextid) {
    $chnavigation .= '<a title="'.get_string('navnext', 'mod_giportfolio').'" href="viewcontribute.php?id='.$cm->id.
